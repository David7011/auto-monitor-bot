...
3. **A17 external acceptance limits.** The [expanded crash/recovery suite](CRASH_RECOVERY_ACCEPTANCE_2026-09-13.md) now proves real process kills before/after journal, fresh-process recovery, stale terminal CAS, deferred partial delivery and durability-enabled PostgreSQL WAL recovery. Its 22 checks/12 fixtures passed. Pre-journal refetch still requires the external source to retain the advert; ambiguous Telegram acceptance with a lost response cannot be honestly guaranteed exactly-once by local replay. Physical power-cut/SSD loss/reboot/autostart certification is separate.
